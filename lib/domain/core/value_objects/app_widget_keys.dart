...
const Key kycOrganizationTrustRadioButtonKey =
    Key('org_coach_trust_radio_button');
const Key kycOrganizationUniversityRadioButtonKey =
    Key('org_coach_university_radio_button');
const Key kycOrganizationCertIncorporationKey =
    Key('org_pharmaceutical_cert_incorporation');
